...
public Technicien() {
	...
	Film f5= new Film(8,"Pulp Fiction","Quentin Tarantino",d5,t5,"data/pulpfiction.jpg");
	Film f6= new Film(9,"The Dark Knight : Le Chevalier noir","Christopher Nolan",d6,t6,"data/thedarkknight.jpg");
	...
	Film f9= new Film(12,"Le Seigneur des anneaux : Le Retour du roi","Peter Jackson",d9,t9,"data/leseigneurdesanneauxleretourduroi.jpg");
